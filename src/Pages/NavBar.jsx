...
const navigation = [
  { name: "Home", href: "/homepage", isCurrent: true },
  { name: "Tags", href: "/tags", isCurrent: false },
  { name: "Users", href: "/users", isCurrent: false },
];
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 items-center justify-between">
                <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                  {/* Mobile menu button*/}
                  <Disclosure.Button className="relative inline-flex items-center justify-center  p-2 text-gray-400 hover:bg-amber-500 hover:text-white ">
